...
function setup_tree(entity)
    local sprite_component = SpriteComponent:new(entity, love.graphics.newImage("assets/sprites/tree.png"),
        { 1, 1, 1, 1 })
...
function setup_dude(entity)
    SpriteComponent:new(entity, love.graphics.newImage("assets/sprites/dude.png"), { 1, 1, 1, 1 }, 35).pivot =
        SPRITE_PIVOT.CENTER_BOTTOM
...
function setup_chaser(entity)
    SpriteComponent:new(entity, love.graphics.newImage("assets/sprites/dude.png"), { 1, 0, 0, 1 }).pivot = SPRITE_PIVOT
        .CENTER_BOTTOM
...
function setup_grass(entity)
    local sprite_component = SpriteComponent:new(entity, love.graphics.newImage("assets/sprites/grass.png"),
        { 1, 1, 1, 1 })
...
function setup_ruin(entity)
    SpriteComponent:new(entity, love.graphics.newImage("assets/sprites/ruin.png"), { 1, 1, 1, 1 }).pivot = SPRITE_PIVOT
        .CENTER_BOTTOM
    entity.draw_priority = 0
...
function setup_berry_bush(entity)
    local sprite_component = SpriteComponent:new(entity, love.graphics.newImage("assets/sprites/berry_bush.png"),
        { 1, 1, 1, 1 })
    sprite_component.pivot = SPRITE_PIVOT.CENTER_BOTTOM
    sprite_component.render_offset_y = -4
    sprite_component.render_offset_x = love.math.random(-GRID_SIZE_HALF_PX / 2, GRID_SIZE_HALF_PX / 2)
...
function setup_dude_corpse(entity)
    local sprite_component = SpriteComponent:new(entity, love.graphics.newImage("assets/sprites/dude_corpse.png"),
        { 1, 1, 1, 1 })
